...
var AXCalendar = Class.create(AXJ, {
     ...
     * var config = {
     *     CT_className : {String},
     *     weeks : {Object} [{ { name: "日" }, { name: "月" }, { name: "火" }, { name: "水" }, { name: "木" }, { name: "金" }, { name: "土" } }],
    ...
    printMonthPage: function (date) {
        ...
        while (i < 4) {
            ...
            while (k < 3) {
                ...
                po.push("<td class=\"bodyCol_" + k + " bodyRow_" + i + " " + tdClass.join(" ") + "\"><a " + cfg.href + " class=\"calendarMonth\" id=\"" + cfg.targetID + "_AX_" + m + "_AX_month\" title=\"\">" + m + "M</a></td>");
                k++;
                m++;
            }
            po.push("</tr>");
    ...
    printYearPage: function (year) {
        ...
        while (i < 4) {
            ...
            while (k < 3) {
                ...
                po.push("<td class=\"bodyCol_" + k + " bodyRow_" + i + " " + tdClass.join(" ") + "\"><a " + cfg.href + " class=\"calendarMonth\" id=\"" + cfg.targetID + "_AX_" + m + "_AX_year\" title=\"\">" + m + "Y</a></td>");
                k++;
                m++;
            }
            po.push("</tr>");
